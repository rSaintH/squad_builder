...
ALTER TABLE public.lineups ADD CONSTRAINT lineups_formation_fk FOREIGN KEY (formation_id) REFERENCES public.formations(id) ON DELETE SET NULL;
...
-- Public access (link-based app, no auth) for anon and authenticated.
...
GRANT ALL ON public.lineups, public.formations, public.formation_positions, public.players, public.lineup_slots TO service_role;
